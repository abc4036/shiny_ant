...
let todayRoundNumber = new Date().setHours(0, 0, 0, 0) - startDate.setHours(0, 0, 0, 0);
let roundNumber = prompt("Please enter round number! (deafult = today)", Math.round(todayRoundNumber / 864e5).toString());
                ...
                value: function() {
                    ...
                    if (["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach((function(s) {
                        ...
                        p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                            ...
                            As(function(e) {
                                const tmpDate = new Date(2021, 5, 19);
                                const playingDate = tmpDate.addDays(roundNumber);
                                var a = e.evaluations,
                                    s = e.dayOffset,
                                    t = e.rowIndex,
                                    o = e.isHardMode,
                                    ...
                                    i = JSON.parse(window.localStorage.getItem(S)),
                                    l = "Wordle ".concat(s).concat("\nDate : " + playingDate.getDate() + "/" + (playingDate.getMonth() + 1) + "/" + playingDate.getFullYear());
                                l += "\nTries : ".concat(n ? t : "X", "/").concat(6), o && (l += "*");
                                var d = "";
